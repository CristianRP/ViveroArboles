...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { category_id: @tax.category_id, description: @tax.description } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { category_id: @tax.category_id, description: @tax.description } }
