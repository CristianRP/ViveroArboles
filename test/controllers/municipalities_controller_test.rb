...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { department_id: @municipality.department_id, name: @municipality.name } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { department_id: @municipality.department_id, name: @municipality.name } }
